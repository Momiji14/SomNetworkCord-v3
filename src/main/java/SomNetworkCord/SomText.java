...
public class SomText implements Cloneable {
    ...
    public SomText addText(SomText text) {
        builder = builder.append(text.toComponent());
        return this;
    }

    public SomText addDeco(String text) {
        builder = builder.append(Component.text("§6======§r " + text + " §6======"));
        return this;
    }
    ...
    public SomText addHover(String text, SomText hoverText) {
        builder = builder.append(Component.text(text).hoverEvent(HoverEvent.showText(hoverText.toComponent())));
        return this;
    }
    ...
    public SomText addClickEvent(String text, SomText hoverText, String command, ClickEvent.Action action) {
        ...
        builder = builder.append(runCommand);
        return this;
    }
